...
driver.get("https://www.homedepot.com/b/Building-Materials/N-5yc1vZaqns")
...
while(medium_index < building_materials_count):
    ...
    if medium_index == 0 or medium_index == 3 or medium_index == 4 or medium_index == 7 or medium_index == 8 or medium_index == 9 or medium_index == 12 or medium_index == 13:
        sub_urls = []
        try:
